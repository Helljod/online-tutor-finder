...
<title>Online Tutor Portal</title>
<!-- // Stylesheets // -->
...
<div id="wrapper_sec">
	<div id="masthead">
    	<div class="logo">
        	<a href="./index.php" class="logo-custom">Online Tutor Portal</a>
        </div>
        ...
        <div class="clear"></div>
            <div class="navigation">
            	<div id="smoothmenu1" class="ddsmoothmenu">
					...
					<li><a href="./tutor-listing.php">Find Tutors</a></li>
					...
					<?php if($_SESSION['user_details']['user_level_id'] == 3) {?>
						...
						<li><a href="#">My Administration</a>
							<ul>
								...
								<li><a href="./course-report.php">My Courses</a></li>
								<li><a href="./report-appointment.php">My Appointments</a></li>
								<li><a href="./user.php?user_id=<?=$_SESSION['user_details']['user_id']?>">My Account</a></li>
							</ul>
						</li>
